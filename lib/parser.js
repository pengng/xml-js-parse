...
const Parser = function (options) {
  options = options || {}
  this.explicitArray = getDefault(options.explicitArray, true)
  this.trim = getDefault(options.trim, false)
  this.normalize = getDefault(options.normalize, false)
  this.normalizeTags = getDefault(options.normalizeTags, false)
  this.ignoreAttrs = getDefault(options.ignoreAttrs, false)
  this.attrkey = getDefault(options.attrkey, '$')
  this.charkey = getDefault(options.charkey, '_')
}

const getDefault = function (value, defaultValue) {
